...
def stress_to_group_current(fine_time, fine_stress, groups, g=.4, h =1, **params):
    ...
    """
    logging.debug("Converting stress to current...")
    ...
    logging.debug("Current conversion complete")
...
def spike_time_to_trace(spike_time):
    ...
    """
    logging.debug("Converting spike time to trace...")
    ...
    logging.debug(f"LIF RESOLUTION: {LifConstants.LIF_RESOLUTION}")
    return spike_trace


def spike_time_to_fr_roll(spike_time, window_size): #calculating the firing rate
    logging.debug("Converting spike time to firing rate...")
    ...
    fr_roll = 1 / isi_roll
    logging.debug("Firing rate calculation complete")
    return fr_roll
